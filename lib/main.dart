...
import 'presentation/blocs/notifications_bloc/notifications_bloc.dart';
        ...
        BlocProvider(
          create: (context) => NotificationsBloc(
            requestLocalNotificationsPermission:
                LocalNotificationService.requestLocalNotificationsPermission,
...
class HandleNotificationInteractions extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _HandleNotificationInteractionsState();
}
...
class _HandleNotificationInteractionsState
  ...
  void _handleMessage(RemoteMessage message) {
    ...
    if (messageId != null) {
      final parsedId = StringFormaters.messageIdParser(messageId);
      appRouter.push('/notification-detail/$parsedId');
    }
  }
